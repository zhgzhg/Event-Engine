...
module net.uniplovdiv.fmi.cs.vrs.event {
    ...
    opens net.uniplovdiv.fmi.cs.vrs.event;
    opens net.uniplovdiv.fmi.cs.vrs.event.location;
    opens net.uniplovdiv.fmi.cs.vrs.event.parameters;
    opens net.uniplovdiv.fmi.cs.vrs.event.parameters.comparison;
}